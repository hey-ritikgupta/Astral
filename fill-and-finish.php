...
<!-- Page Title START -->
<div class="page-title-section" style="background-image: url('img/banner/2.png'); background-repeat: no-repeat; background-size:cover; background-position: center;">
	<div class="black-overlay-70"></div>
	<div class="container">
		<h1>CORE EXPERTISE</h1>
		<p>Aseptic Fill and Finish</p>
	</div>
</div>
<!-- Page Title END -->
<!-- Serive Start -->
