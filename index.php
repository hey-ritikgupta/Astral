	...
	<div class="swiper-wrapper">
			...
			<div class="container">
				<div class="slider-content text-center">
					<h2 class="animated fadeInDown mb-0">
						Welcome to<br> Astral SteriTech
					</h2>
					<div class="row">
					...
					<div class="animated fadeInUp mt-30">
						<a href="about.php" class="button-primary button-lg hvr-sweep-to-right">Learn More</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="swiper-slide" style="background-image:url('img/banner/2.png')">
			...
			<div class="container">
				<div class="slider-content text-center">
					<h2 class="animated fadeInDown mb-0">
						State-of-the-art<br> manufacturing capabilities
					</h2>
					<div class="row">
						<div class="col-md-6 col-sm-12 col-12 offset-md-3">
							<p class=" white-color animated fadeInDown">
...
<main>
			...
			<div class="row">
				...
				<div class="col-sm-12 col-lg-6 offset-lg-1 cir-divs">
                    ...
                    <div class="icons-3"></div>
					 <i style="right:23%;" class="fa fa-thermometer"></i>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- Innovative END -->
    <section class="section actionbanner" style="background: url(img/actionbanner.jpg);
width: 100%;
height: auto;" id="advantage">
  <div class="container">
  <div class="row">
      <div class="col-12">
...
<!--            <img class="center" src="img/advantage.png" width="60%">-->
		...
		<div class="container">
			<div class="row justify-content-center mb-5">
				<div class="col-md-12 col-lg-8 col-centered text-center">
					<h3 class="s-title textcolor">Pillars of Strength for Strategic Collaboration</h3>
				      <hr class="service-hr" style="width:40%;">
				</div>
			</div>
			<div class="row mt-5">
				<div class="col-md-6 col-lg-3 col-sm-6 col-12">
					<div class="infobox s-pdl-30 s-pdr-30" style="height:100%;">
						...
						<h4>Manufacturing</h4>
						<p>Extensive and comprehensive experience for manufacturing products with Aseptic Processing Techniques with cGMP compliance offers distinct advantage as support manufacturer.</p>
					</div>
				</div>
				<div class="col-md-6 col-lg-3 col-sm-6 col-12">
					<div class="infobox s-pdl-30 s-pdr-30" style="height:100%;">
						<i class="fas fa-clipboard-check"></i>
						<h4 class="s-mrb-30 s-mrt-40">Quality</h4>
						<p>Quality Management Systems (QMS) have been progressively upgraded to build in robustness to control processes and data integrity, in the form of module wise installation of the Electronic Data System for QMS, Quality Control Lab, Batch Records and Regulatory Submissions.</p>
					</div>
				</div>
				<div class="col-md-6 col-lg-3 col-sm-6 col-12">
					<div class="infobox s-pdl-30 s-pdr-30" style="height:100%;">
					...
					<div class="infobox s-pdl-30 s-pdr-30" style="height:100%;">
						...
						<h4 class="s-mrb-30 s-mrt-40">Alliances</h4>
						<p>Seamless and progressive relationships running over multiple decades as a reliable CDMO with reputed national and overseas customers and vendors.</p>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- Features END -->
    <section class="section header1 overlay bg-cover" >
  <video class="" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
    <source src="video/Final Loop.mp4" type="video/mp4" >
  </video>
  <div class="container">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-8 col-centered s-mrb-60">
					<h3 class="s-title textcolor text-center">CORE EXPERTISE</h3>
					<hr class="service-hr">
				</div>
			</div>
			<div class="row">
